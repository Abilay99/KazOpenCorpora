...
for filename in glob.glob(os.path.join(os.path.join(papka_korpus, "outtexts"), '*.gototrain')):
    with open(filename, 'r', encoding="utf-8") as f:
        ...
        for x in tf:
            ...
            elif i > 15 and idf[x] != 0.0:
                ws.write(i, j, str(x), style2)
                ws.write(i, j+1, str(tf[x]), style2)
            else:
                ws.write(i, j, str(x), style3)
                ws.write(i, j+1, str(tf[x]), style3) 
            i += 1
        nexti = 1
        for x in bi_tf:
            if nexti < 16:
            ...
            elif nexti > 15 and bi_idf[x] != 0.0:
                ws.write(i, j, str(x), style2)
                ws.write(i, j+1, str(bi_tf[x]), style2)
            else:
                ws.write(i, j, str(x), style3)
                ws.write(i, j+1, str(bi_tf[x]), style3)
            i += 1
            nexti += 1
        i = 1
        j = 2
        ...
        for x in idf:
            if i < 16:
                ...
                ws.write(i, j, str(x), style2)
                ws.write(i, j+1, str(idf[x]), style2)
            else:
                ws.write(i, j, str(x), style3)
                ws.write(i, j+1, str(idf[x]), style3)
            i += 1
        nexti = 1
        for x in bi_idf:
            if nexti < 16:
                ...
                ws.write(i, j, str(x), style2)
                ws.write(i, j+1, str(bi_idf[x]), style2)
            else:
                ws.write(i, j, str(x), style3)
                ws.write(i, j+1, str(bi_idf[x]), style3)
            i += 1
            nexti += 1
        i = 1
        j = 4
        ...
        for x in tfidf:
            if i < 16:
                ...
                ws.write(i, j, str(x), style2)
                ws.write(i, j+1, str(tfidf[x]), style2)
            else:
                ws.write(i, j, str(x), style3)
                ws.write(i, j+1, str(tfidf[x]), style3)
            i += 1
        nexti = 1
        for x in bi_tfidf:
            if nexti < 16:
                ...
                ws.write(i, j, str(x), style2)
                ws.write(i, j+1, str(bi_tfidf[x]), style2)
            else:
                ws.write(i, j, str(x), style3)
                ws.write(i, j+1, str(bi_tfidf[x]), style3)
            i += 1
            nexti += 1
wb.save(os.path.join(papka_korpus, "keywords_tolyq.xls"))